...
def test_get_sample_sizes_handles_nans_and_minimums(fake_transport_zones_asset, transport_zones_dataframe, monkeypatch):
    ...
    # n_persons is integer and at least 1 everywhere
    assert np.issubdtype(sample_sizes["n_persons"].dtype, np.integer)
